 ...
 *
 */
function mp_jplayer_embed_create_meta_box(){	
	
	/**
	 * Array which stores all info about the new metabox
	 *
	 */
	$mp_jplayer_embed_add_meta_box = array(
		'metabox_id' => 'mp_jplayer_embed_metabox', 
	 ...
	 *
	 */
	$mp_jplayer_embed_items_array = array(
		array(
	 ...
	 */
	$mp_jplayer_embed_add_meta_box = has_filter('mp_jplayer_embed_meta_box_array') ? apply_filters( 'mp_jplayer_embed_meta_box_array', $mp_jplayer_embed_add_meta_box) : $mp_jplayer_embed_add_meta_box;
	
	/**
	 * Custom filter to allow for add on plugins to hook in their own extra fields 
	 */
	$mp_jplayer_embed_items_array = has_filter('mp_jplayer_embed_items_array') ? apply_filters( 'mp_jplayer_embed_items_array', $mp_jplayer_embed_items_array) : $mp_jplayer_embed_items_array;
	
	
	/**
	 * Create Metabox class
	 */
	global $mp_jplayer_embed_meta_box;
	$mp_jplayer_embed_meta_box = new MP_CORE_Metabox($mp_jplayer_embed_add_meta_box, $mp_jplayer_embed_items_array);
}
add_action('plugins_loaded', 'mp_jplayer_embed_create_meta_box');
...
add_filter('mp_embed_code_description', 'mp_jplayer_embed_set_embed_code', 10, 2);
...
add_filter('mp_preview_player_description', 'mp_jplayer_embed_set_preview_code', 10, 2);
